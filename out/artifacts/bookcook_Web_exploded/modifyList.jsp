    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <form class="form-horizontal jumbotron" action="ModifyListServlet" method="post" role="form">
                    <h2 class="centerText"><b>添加新的欲读书目</b></h2>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" placeholder="作者" name="bookAuthor" id="inputPassword3">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" placeholder="类别" name="bookClass" id="inputPassword3">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" placeholder="状态" name="status" id="inputPassword3">
                        </div>
                    </div>
                    <div class="blank-20"></div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <a href="list.jsp" class="btn btn-primary btn-full">
                                返回
                            </a>
                        </div>
                    </div>
